...
1. Rate Limiting
   - Prevent DoS attack
   - API available for legitimate users
2. Message Validation
   - Prevent Injections
   - Validate Incoming and outgoing messages
   - Schema Based validation
3. Encription and Signing
   - Prevent Spoofing and man-in-the-middele attacke
 4. Access Control
    - Restrict usage of API based on user identity (Like... Authintication / Authorization)
